...
import { generatePatrioticImage, editImageWithPrompt, analyzeAvatarForConcepts } from '../services/geminiService.ts';
                ...
                >
                    ...
                    <div className="flex items-center gap-4 mt-4">
                        ...
                        <button 
                            ...
                            disabled={appState.selectedIdeas.length < minIdeas || appState.selectedIdeas.length > maxIdeas || isLoading || isAnalyzing}
                        >
                            {getButtonText()}
                        </button>
                    </div>
