...
export const LayerComposerModal: React.FC<LayerComposerModalProps> = ({ isOpen, onClose, onHide }) => {
    ...
    const addLayer = useCallback((layerData: Omit<Layer, 'id'>) => {
        ...
        beginInteraction();
// FIX: Replaced spread syntax with Object.assign to prevent "Spread types may only be created from object types" error if layerData's type is inferred incorrectly.
